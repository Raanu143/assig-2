...
Original file is located at
    https://colab.research.google.com/drive/1xbr3MbtpTic1s78DCllL3ouG-4Zlabcp
"""
...
def read_dataset(Df_file):
    ...
    return data_Agricultural1,data_Agricultural4

# read dataset path  and make  two data frame 
Df_file=('/content/drive/MyDrive/API_1_DS2_en_csv_v2_4550063.csv') 
#make two data frame 
data_ag1,data_ag2=read_dataset(Df_file)
# showing data frame 1
data_ag1.head(6)

data_ag2.head(6) # showing data frame 2
